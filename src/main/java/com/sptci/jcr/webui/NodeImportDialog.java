...
import com.sptci.jcr.webui.model.ImportBehaviour;
 ...
 * @version $Id: NodeImportDialog.java 51 2010-01-26 21:51:13Z spt $
 */
public class NodeImportDialog extends WindowPane
{
  ...
  @ActionListener( value = "com.sptci.jcr.webui.listener.NodeImportListener" )
  ...
  public Node getNode() { return path.getNode(); }
